                ...
                <Box>
                    <Grid container spacing={2} marginY={2}>
                        <Grid xs={3} textAlign='center' paddingTop={1} sx={{ display: { xs: "none", md: "block" } }}>
                            <Typography fontSize={12} component='a' href={'https://github.com/mattsunkun/portfolio'} color={"inherit"} sx={{ textDecoration: 'none' }}>© 2023 Masaaki MATSUMOTO</Typography>
                        </Grid>
                        <Grid xs={3} marginY={1}>
                            <Box>
                                <LinkLine link={ePage.home} line="Home" />
                                <LinkLine link={ePage.about} line="About" />
                                <LinkLine link={ePage.skills} line="Skills" />
                                <LinkLine link={ePage.products} line="Products" />
                                <LinkLine link={ePage.history} line="History" />
                            </Box>
                        </Grid>
                        <Grid xs={3} marginY={1}>
                            <Box>
